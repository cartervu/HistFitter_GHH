...
set -x
ps -p 25811
echo /afs/cern.ch/user/c/cvu/HistFitterTutorial/batch/testchannel_testtype_testtarget


# export HOME='/eos/user/c/cvu'
...
source run_HF.sh testchannel testtype testtarget
